...
type PageData struct {
	...
	AdvanceLabels shared.TreasuryAdvanceLabels
	AdvanceEnum   shared.AdvanceEnumLabels
	ActiveTab     string
...
func disbursementToMap(d *disbursementpb.Disbursement, enumLabels shared.AdvanceEnumLabels) map[string]any {
...
func advanceKindLabel(s string, l shared.AdvanceKindLabels) string {
	switch s {
...
func advanceStatusLabel(s string, l shared.AdvanceStatusLabels) string {
	switch s {
...
func advanceProrationPolicyLabel(s string, l shared.AdvanceProrationPolicyLabels) string {
	switch s {
...
func buildTabItems(l disbursement.Labels, id string, routes disbursement.Routes) []pyeza.TabItem {
...
func buildTabItemsWithAdvance(l disbursement.Labels, id string, routes disbursement.Routes, isAdvance bool, advanceTabLabel string) []pyeza.TabItem {
...
func buildAuditTable(l disbursement.Labels, tableLabels types.TableLabels) *types.TableConfig {
