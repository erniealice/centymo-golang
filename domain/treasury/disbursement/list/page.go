...
func disbursementColumns(l disbursement.Labels) []types.TableColumn {
...
func statusPageTitle(l disbursement.Labels, status string) string {
	switch status {
	case "draft":
...
func statusPageCaption(l disbursement.Labels, status string) string {
	switch status {
	case "draft":
...
func statusEmptyTitle(l disbursement.Labels, status string) string {
	switch status {
	case "draft":
...
func statusEmptyMessage(l disbursement.Labels, status string) string {
	switch status {
	case "draft":
...
func buildBulkActions(l disbursement.Labels, status string, routes disbursement.Routes) []types.BulkAction {
