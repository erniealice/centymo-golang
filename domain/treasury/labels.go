...
//
// Collection (money IN), Disbursement (money OUT), and the Cash dashboard
// labels, extracted verbatim from the root labels.go god-file into the
// treasury domain package per the domain-first restructure. Pure structural
// move — no behaviour change. Lyngua JSON load paths are unchanged.
