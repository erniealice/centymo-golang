...
func collectionToMap(c *collectionpb.Collection, enumLabels shared.AdvanceEnumLabels) map[string]any {
...
func buildTabItems(l collection.Labels, id string, routes collection.Routes) []pyeza.TabItem {
...
func buildTabItemsWithAdvance(l collection.Labels, id string, routes collection.Routes, isAdvance bool, advanceTabLabel string) []pyeza.TabItem {
...
func buildAuditTable(l collection.Labels, tableLabels types.TableLabels) *types.TableConfig {
