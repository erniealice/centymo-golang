...
// CollectionModuleDeps holds all dependencies for the collection module.
type CollectionModuleDeps struct {
	Routes       epkg.Routes
	Labels       epkg.Labels
...
// CollectionModule holds all constructed collection views.
...
// NewCollectionModule creates the collection module with all views wired.
func NewCollectionModule(deps *CollectionModuleDeps) *CollectionModule {
...
func (m *CollectionModule) RegisterRoutes(r view.RouteRegistrar) {
