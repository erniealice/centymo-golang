...
type ModuleDeps struct {
	...
	Labels       treasury.AdvancesDashboardLabels
...
func buildSectionTable(side string, sectionLabels treasury.AdvancesDashboardSectionLabels, tableLabels types.TableLabels, rows []AdvanceRow) *types.TableConfig {
