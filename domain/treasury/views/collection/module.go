...
import (
	...
	collectionaction "github.com/erniealice/centymo-golang/domain/treasury/views/collection/action"
	collectiondashboard "github.com/erniealice/centymo-golang/domain/treasury/views/collection/dashboard"
	collectiondetail "github.com/erniealice/centymo-golang/domain/treasury/views/collection/detail"
	collectionlist "github.com/erniealice/centymo-golang/domain/treasury/views/collection/list"
)
...
type ModuleDeps struct {
	...
	SettleUnscheduledAdvance func(ctx context.Context, in treasury.AdvanceSettleViewInput) (*treasury.AdvanceSettleViewOutput, error)
	RefundUnscheduledAdvance func(ctx context.Context, in treasury.AdvanceRefundViewInput) (*treasury.AdvanceRefundViewOutput, error)
	CancelAdvance            func(ctx context.Context, in treasury.AdvanceCancelViewInput) (*treasury.AdvanceCancelViewOutput, error)
}
