...
func collectionToMap(c *collectionpb.Collection, enumLabels treasury.AdvanceEnumLabels) map[string]any {
...
func buildTabItems(l treasury.CollectionLabels, id string, routes treasury.CollectionRoutes) []pyeza.TabItem {
...
func buildTabItemsWithAdvance(l treasury.CollectionLabels, id string, routes treasury.CollectionRoutes, isAdvance bool, advanceTabLabel string) []pyeza.TabItem {
...
func buildAuditTable(l treasury.CollectionLabels, tableLabels types.TableLabels) *types.TableConfig {
