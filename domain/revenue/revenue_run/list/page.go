...
func revenueRunColumns(l revenuedomain.Labels) []types.TableColumn {
	lc := l.List.Columns
...
func buildTableRows(rows []rrshared.RevenueRunRow, l revenuedomain.Labels, routes revenuedomain.Routes) []types.TableRow {
...
func statusBadge(l revenuedomain.Labels, status string) (label, variant string) {
	switch status {
	case "pending":
...
func scopeKindLabel(l revenuedomain.Labels, kind string) string {
	switch kind {
	case "subscription":
