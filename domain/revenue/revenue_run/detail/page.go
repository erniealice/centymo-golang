...
import (
	...
	detailform "github.com/erniealice/centymo-golang/domain/revenue/revenue_run/detail/form"
...
func buildSelectionsTable(attempts []rrshared.RevenueRunAttemptRow, l revenuedomain.Labels, tableLabels types.TableLabels) *types.TableConfig {
...
func buildResultsTable(attempts []rrshared.RevenueRunAttemptRow, l revenuedomain.Labels, tableLabels types.TableLabels) *types.TableConfig {
	lr := l.Detail.Results
	columns := []types.TableColumn{
...
func buildInvoicesTable(revenues []rrshared.RevenueRow, l revenuedomain.Labels, tableLabels types.TableLabels) *types.TableConfig {
...
func outcomeCell(l revenuedomain.Labels, outcome string) (label, variant string) {
	switch outcome {
	case "created":
