...
func buildFormLabels(t func(string) string) form.Labels {
	return form.Labels{
		...
		ReferencePlaceholder:        t("revenue.form.reference_placeholder"),
		Status:                      t("revenue.form.status"),
		Notes:                       t("revenue.form.notes"),
		NotesPlaceholder:            t("revenue.form.notes_placeholder"),
		Location:                    t("revenue.form.location"),
		PaymentTerms:                t("revenue.form.payment_terms"),
		SelectPaymentTerm:           t("revenue.form.select_payment_term"),
		DueDate:                     t("revenue.form.due_date"),
		Subscription:                t("revenue.form.subscription"),
		SubscriptionNoResults:       t("revenue.form.subscription_no_results"),
		RevenueType:                 t("revenue.form.revenue_type"),
		RevenueTypeOneTime:          t("revenue.form.revenue_type_one_time"),
		RevenueTypeFromSubscription: t("revenue.form.revenue_type_from_subscription"),
		RevenueTypeFromActivities:   t("revenue.form.revenue_type_from_activities"),
		ActivityIDs:                 t("revenue.form.activity_ids"),
		ActivityIDsPlaceholder:      t("revenue.form.activity_ids_placeholder"),
		Form: form.Inner{
			SectionInfo:               t("revenue.form.section_info"),
			CurrencyPlaceholder:       t("revenue.form.currency_placeholder"),
			StatusDraft:               t("revenue.form.status_draft"),
			StatusComplete:            t("revenue.form.status_complete"),
			StatusCancelled:           t("revenue.form.status_cancelled"),
			CustomerNamePlaceholder:   t("revenue.form.customer_name_placeholder"),
			CustomerSearchPlaceholder: t("revenue.form.customer_search_placeholder"),
			CustomerNoResults:         t("revenue.form.customer_no_results"),
			LocationPlaceholder:       t("revenue.form.location_placeholder"),
			LocationSearchPlaceholder: t("revenue.form.location_search_placeholder"),
			LocationNoResults:         t("revenue.form.location_no_results"),
		},
		ReferenceInfo:    t("revenue.form.reference_info"),
		DateInfo:         t("revenue.form.date_info"),
		CustomerInfo:     t("revenue.form.customer_info"),
		LocationInfo:     t("revenue.form.location_info"),
		SubscriptionInfo: t("revenue.form.subscription_info"),
		CurrencyInfo:     t("revenue.form.currency_info"),
		NotesInfo:        t("revenue.form.notes_info"),
		// Tax section (Phase 5)
		SectionTax:              t("revenue.form.section_tax"),
		TaxDirectionSurcharge:   t("revenue.form.tax_direction_surcharge"),
		TaxDirectionWithholding: t("revenue.form.tax_direction_withholding"),
		TaxKind:                 t("revenue.form.tax_kind"),
		TaxRegCode:              t("revenue.form.tax_reg_code"),
		TaxRate:                 t("revenue.form.tax_rate"),
		TaxableBase:             t("revenue.form.taxable_base"),
		TaxAmount:               t("revenue.form.tax_amount"),
		NetReceivable:           t("revenue.form.net_receivable"),
		WHTAmount:               t("revenue.form.wht_amount"),
		GrandTotal:              t("revenue.form.grand_total"),
		SettlementStatus:        t("revenue.form.settlement_status"),
		Recompute:               t("revenue.form.recompute"),
		AddWHTCertificate:       t("revenue.form.add_whtcertificate"),
		Billed:                  t("revenue.form.billed"),
		Recorded:                t("revenue.form.recorded"),
		Rate:                    t("revenue.form.rate"),
		RateSourceOperator:      t("revenue.form.rate_source_operator"),
		// TaxKindLabels maps tax_kind_snapshot values to localized display names (Phase 5 M1).
		TaxKindLabels: map[string]string{
			"VAT_STANDARD":                t("revenue.form.tax_kind_vat_standard"),
			"WHT_PROFESSIONAL_INDIVIDUAL": t("revenue.form.tax_kind_wht_professional_individual"),
			"WHT_PROFESSIONAL_CORPORATE":  t("revenue.form.tax_kind_wht_professional_corporate"),
			"WHT_RENTAL":                  t("revenue.form.tax_kind_wht_rental"),
			"WHT_GOODS_TWA":               t("revenue.form.tax_kind_wht_goods_twa"),
			"WHT_SERVICES_TWA":            t("revenue.form.tax_kind_wht_services_twa"),
			"WHT_NON_RESIDENT":            t("revenue.form.tax_kind_wht_non_resident"),
		},
	}
}
	...
	for _, item := range resp.GetData() {
		if item.GetRevenueId() == revenueID {
			items = append(items, map[string]any{
				...
				"cost_price":          formatCentavos(item.GetCostPrice()),
