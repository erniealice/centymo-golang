...
func revenueColumns(l revenuedomain.Labels) []types.TableColumn {
...
func buildTableRows(revenues []*revenuepb.Revenue, status string, l revenuedomain.Labels, routes revenuedomain.Routes, perms *types.UserPermissions) []types.TableRow {
	rows := []types.TableRow{}
...
func statusPageTitle(l revenuedomain.Labels, status string) string {
	switch status {
	case "draft":
...
func statusPageCaption(l revenuedomain.Labels, status string) string {
	switch status {
	case "draft":
...
func statusEmptyTitle(l revenuedomain.Labels, status string) string {
	switch status {
	case "draft":
...
func statusEmptyMessage(l revenuedomain.Labels, status string) string {
	switch status {
	case "draft":
...
func buildBulkActions(common pyeza.CommonLabels, l revenuedomain.Labels, status string, routes revenuedomain.Routes, hasAnyCollection bool) []types.BulkAction {
