...
func testRevenueLabels() revenuedomain.Labels {
	return revenuedomain.Labels{
		Errors: revenuedomain.ErrorLabels{
			PermissionDenied:        "Missing permission",
			HasPaymentsCannotCancel: "Has payments — cannot cancel",
		},
		Actions: revenuedomain.ActionLabels{
			View:              "View",
			Edit:              "Edit",
			Complete:          "Complete",
			Cancel:            "Cancel",
...
func testRevenueRoutes() revenuedomain.Routes {
	return revenuedomain.DefaultRoutes()
}
