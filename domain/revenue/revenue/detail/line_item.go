...
type LineItemFormData struct {
	...
	CommonLabels     any
	Labels           revenuedomain.DetailLabels
}
...
func buildLineItemTableWithActions(items []map[string]any, l revenuedomain.Labels, tableLabels types.TableLabels, currency string, revenueID string, routes revenuedomain.Routes, perms *types.UserPermissions) *types.TableConfig {
