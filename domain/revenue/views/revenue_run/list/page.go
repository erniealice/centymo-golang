...
func revenueRunColumns(l revenuedomain.RevenueRunLabels) []types.TableColumn {
	lc := l.List.Columns
...
func buildTableRows(rows []rrshared.RevenueRunRow, l revenuedomain.RevenueRunLabels, routes revenuedomain.RevenueRunRoutes) []types.TableRow {
...
func statusBadge(l revenuedomain.RevenueRunLabels, status string) (label, variant string) {
	switch status {
	case "pending":
...
func scopeKindLabel(l revenuedomain.RevenueRunLabels, kind string) string {
	switch kind {
	case "subscription":
...
func statusPageTitle(l revenuedomain.RevenueRunLabels, status string) string {
	switch status {
	case "pending":
...
func statusEmptyTitle(l revenuedomain.RevenueRunLabels, status string) string {
	switch status {
	case "pending":
...
func statusEmptyMessage(l revenuedomain.RevenueRunLabels, status string) string {
	switch status {
	case "pending":
