...
import (
	...
	detailform "github.com/erniealice/centymo-golang/domain/revenue/views/revenue_run/detail/form"
	rrshared "github.com/erniealice/centymo-golang/domain/revenue/views/revenue_run/shared"
...
type DetailViewDeps struct {
	Routes       revenuedomain.RevenueRunRoutes
	Labels       revenuedomain.RevenueRunLabels
...
func buildTabItems(l revenuedomain.RevenueRunLabels, id string, routes revenuedomain.RevenueRunRoutes) []pyeza.TabItem {
...
func buildSelectionsTable(attempts []rrshared.RevenueRunAttemptRow, l revenuedomain.RevenueRunLabels, tableLabels types.TableLabels) *types.TableConfig {
...
func buildResultsTable(attempts []rrshared.RevenueRunAttemptRow, l revenuedomain.RevenueRunLabels, tableLabels types.TableLabels) *types.TableConfig {
	lr := l.Detail.Results
	columns := []types.TableColumn{
...
func buildInvoicesTable(revenues []rrshared.RevenueRow, l revenuedomain.RevenueRunLabels, tableLabels types.TableLabels) *types.TableConfig {
...
func outcomeCell(l revenuedomain.RevenueRunLabels, outcome string) (label, variant string) {
	switch outcome {
	case "created":
