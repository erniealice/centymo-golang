...
import (
	...
	queueform "github.com/erniealice/centymo-golang/domain/revenue/views/revenue_run/queue/form"
...
func queueColumns(l revenuedomain.RevenueRunLabels) []types.TableColumn {
	lc := l.Queue.Columns
...
func buildTableRows(
	...
	l revenuedomain.RevenueRunLabels,
