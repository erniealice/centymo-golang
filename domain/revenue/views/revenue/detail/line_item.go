...
type LineItemFormData struct {
	...
	CommonLabels     any
	Labels           revenuedomain.RevenueDetailLabels
}
...
func buildLineItemTableWithActions(items []map[string]any, l revenuedomain.RevenueLabels, tableLabels types.TableLabels, currency string, revenueID string, routes revenuedomain.RevenueRoutes, perms *types.UserPermissions) *types.TableConfig {
