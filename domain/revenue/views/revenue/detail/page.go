...
func buildTabItems(l revenuedomain.RevenueLabels, id string, routes revenuedomain.RevenueRoutes) []pyeza.TabItem {
...
func buildLineItemTable(items []map[string]any, l revenuedomain.RevenueLabels, tableLabels types.TableLabels, currency string) *types.TableConfig {
...
func buildAuditTable(l revenuedomain.RevenueLabels, tableLabels types.TableLabels) *types.TableConfig {
	columns := []types.TableColumn{
...
func buildPaymentTable(payments []map[string]any, l revenuedomain.RevenueLabels, tableLabels types.TableLabels, currency string, revenueID string, routes revenuedomain.RevenueRoutes, perms *types.UserPermissions) *types.TableConfig {
	columns := []types.TableColumn{
