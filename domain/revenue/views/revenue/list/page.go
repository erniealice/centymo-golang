...
type ListViewDeps struct {
	Routes          revenuedomain.RevenueRoutes
	...
	Labels          revenuedomain.RevenueLabels
...
func revenueColumns(l revenuedomain.RevenueLabels) []types.TableColumn {
...
func buildTableRows(revenues []*revenuepb.Revenue, status string, l revenuedomain.RevenueLabels, routes revenuedomain.RevenueRoutes, perms *types.UserPermissions) []types.TableRow {
	rows := []types.TableRow{}
...
func statusPageTitle(l revenuedomain.RevenueLabels, status string) string {
	switch status {
	case "draft":
...
func statusPageCaption(l revenuedomain.RevenueLabels, status string) string {
	switch status {
	case "draft":
...
func statusEmptyTitle(l revenuedomain.RevenueLabels, status string) string {
	switch status {
	case "draft":
...
func statusEmptyMessage(l revenuedomain.RevenueLabels, status string) string {
	switch status {
	case "draft":
...
func buildBulkActions(common pyeza.CommonLabels, l revenuedomain.RevenueLabels, status string, routes revenuedomain.RevenueRoutes, hasAnyCollection bool) []types.BulkAction {
