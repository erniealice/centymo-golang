...
type RecognizeMilestoneAdvanceDisbursementFn func(
	ctx context.Context,
	in shared.AdvanceRecognizeMilestoneInput,
) (*shared.AdvanceRecognizeMilestoneOutput, error)
...
func NewRecognizeAction(
	...
	errLabels supplier_billing_event.ErrorLabels,
) view.View {
	return view.ViewFunc(func(ctx context.Context, viewCtx *view.ViewContext) view.ViewResult {
		...
		out, err := recognize(ctx, shared.AdvanceRecognizeMilestoneInput{
			AdvanceID: advanceID,
			EventID:   eventID,
		})
		if err != nil {
