...
func statusLabel(s supplierbillingeventpb.SupplierBillingEventStatus, l supplier_billing_event.StatusLabels) string {
	switch s {
	case supplierbillingeventpb.SupplierBillingEventStatus_SUPPLIER_BILLING_EVENT_STATUS_READY:
		return l.Ready
	case supplierbillingeventpb.SupplierBillingEventStatus_SUPPLIER_BILLING_EVENT_STATUS_BILLED:
...
func triggerLabel(t supplierbillingeventpb.SupplierBillingEventTrigger, l supplier_billing_event.TriggerLabels) string {
	switch t {
