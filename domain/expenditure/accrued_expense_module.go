...
//	  2. Add a centymo block.go entry that constructs AccruedExpenseModuleDeps from the
//	     domain providers (espyna AccruedExpense + AccruedExpenseSettlement
//	     use case groups) and calls NewAccruedExpenseModule + RegisterRoutes.
...
import (
	...
	accruedexpenseaction "github.com/erniealice/centymo-golang/domain/expenditure/accrued_expense/action"
	accruedexpensedetail "github.com/erniealice/centymo-golang/domain/expenditure/accrued_expense/detail"
	accruedexpenselist "github.com/erniealice/centymo-golang/domain/expenditure/accrued_expense/list"
	...
	epkg "github.com/erniealice/centymo-golang/domain/expenditure/accrued_expense"
	pyeza "github.com/erniealice/pyeza-golang"
	"github.com/erniealice/pyeza-golang/types"
	"github.com/erniealice/pyeza-golang/view"
)

// AccruedExpenseModuleDeps holds all dependencies for the accrued_expense module.
type AccruedExpenseModuleDeps struct {
	Routes       epkg.Routes
	Labels       epkg.Labels
...
// AccruedExpenseModule holds all constructed accrued_expense views.
type AccruedExpenseModule struct {
	routes             epkg.Routes
	List               view.View
	Detail             view.View
	TabAction          view.View
...
// NewAccruedExpenseModule creates the accrued_expense module with all views wired.
func NewAccruedExpenseModule(deps *AccruedExpenseModuleDeps) *AccruedExpenseModule {
...
func (m *AccruedExpenseModule) RegisterRoutes(r view.RouteRegistrar) {
