...
type DetailViewDeps struct {
	Routes       procurement_request.Routes
	Labels       procurement_request.Labels
...
func statusDisplayLabel(l procurement_request.Labels, status string) string {
	switch status {
	case "PROCUREMENT_REQUEST_STATUS_DRAFT":
...
func strategyDisplayLabel(l procurement_request.Labels, strategy string) string {
	switch strategy {
...
func fulfillmentModeDisplay(l procurement_request.Labels, mode string) (label, token string) {
	switch mode {
...
func spawnStatusDisplay(l procurement_request.Labels, status string) (label, badge string) {
	switch status {
...
func buildLineTable(ctx context.Context, deps *DetailViewDeps, requestID string, l procurement_request.Labels) *types.TableConfig {
	prIDPtr := requestID
...
func buildSpawnedPOTable(ctx context.Context, deps *DetailViewDeps, requestID string, l procurement_request.Labels) *types.TableConfig {
