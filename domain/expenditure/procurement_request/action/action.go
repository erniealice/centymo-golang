...
import (
	...
	"github.com/erniealice/centymo-golang/domain/expenditure/procurement_request/form"
)
...
func buildEmptyFormData(ctx context.Context, deps *Deps, l procurement_request.Labels) *form.Data {
	fd := &form.Data{
		Labels:       l.Form,
