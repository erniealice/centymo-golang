...
//
//	Block-level wiring (NewExpenseRecognitionModule call + dependency injection from espyna use
//	cases) is intentionally DEFERRED to the main thread. This package
//	exposes ExpenseRecognitionModule + ExpenseRecognitionModuleDeps + RegisterRoutes following the same
//	convention as views/supplier_contract/. The integrator must:
//	  1. Register routes/labels in apps/service-admin sidebar.
//	  2. Add a centymo block.go entry that constructs ExpenseRecognitionModuleDeps from the
//	     domain providers and calls NewExpenseRecognitionModule + RegisterRoutes.
...
import (
	...
	expenserecognitionaction "github.com/erniealice/centymo-golang/domain/expenditure/expense_recognition/action"
	expenserecognitiondetail "github.com/erniealice/centymo-golang/domain/expenditure/expense_recognition/detail"
	expenserecognitionlist "github.com/erniealice/centymo-golang/domain/expenditure/expense_recognition/list"
	...
	epkg "github.com/erniealice/centymo-golang/domain/expenditure/expense_recognition"
	pyeza "github.com/erniealice/pyeza-golang"
	"github.com/erniealice/pyeza-golang/types"
	"github.com/erniealice/pyeza-golang/view"
)

// ExpenseRecognitionModuleDeps holds all dependencies for the expense_recognition module.
type ExpenseRecognitionModuleDeps struct {
	Routes       epkg.Routes
	Labels       epkg.Labels
...
// ExpenseRecognitionModule holds all constructed expense_recognition views.
type ExpenseRecognitionModule struct {
	routes                   epkg.Routes
	List                     view.View
	Detail                   view.View
	TabAction                view.View
...
// NewExpenseRecognitionModule creates the expense_recognition module with all views wired.
func NewExpenseRecognitionModule(deps *ExpenseRecognitionModuleDeps) *ExpenseRecognitionModule {
...
func (m *ExpenseRecognitionModule) RegisterRoutes(r view.RouteRegistrar) {
