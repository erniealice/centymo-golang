...
type ListViewDeps struct {
	Routes                             supplier_contract_price_schedule.Routes
	Labels                             supplier_contract_price_schedule.Labels
...
func scheduleColumns(l supplier_contract_price_schedule.Labels) []types.TableColumn {
...
func buildTableRows(schedules []*scpspb.SupplierContractPriceSchedule, contractNames map[string]string, l supplier_contract_price_schedule.Labels) []types.TableRow {
...
func scheduleStatusLabel(status string, l supplier_contract_price_schedule.Labels) string {
	switch status {
	case "SUPPLIER_CONTRACT_PRICE_SCHEDULE_STATUS_SCHEDULED":
...
func statusPageTitle(l supplier_contract_price_schedule.Labels, status string) string {
	switch status {
	case "SUPPLIER_CONTRACT_PRICE_SCHEDULE_STATUS_SCHEDULED":
