...
func buildPageData(viewCtx *view.ViewContext, deps *DetailViewDeps, l supplier_contract_price_schedule.Labels, schedule *scpspb.SupplierContractPriceSchedule, activeTab, id string) *PageData {
	startStr := ""
...
func buildLineItemTable(ctx context.Context, deps *DetailViewDeps, scheduleID string, l supplier_contract_price_schedule.Labels) *types.TableConfig {
