...
import (
	...
	"github.com/erniealice/centymo-golang/domain/expenditure/supplier_contract_price_schedule/form"
)
...
func buildEmptyFormData(ctx context.Context, deps *Deps, l supplier_contract_price_schedule.Labels) *form.Data {
	fd := &form.Data{
		Labels:       l.Form,
