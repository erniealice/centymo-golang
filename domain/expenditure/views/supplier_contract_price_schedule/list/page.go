...
type ListViewDeps struct {
	Routes                             expenditure.SupplierContractPriceScheduleRoutes
	Labels                             expenditure.SupplierContractPriceScheduleLabels
...
func NewView(deps *ListViewDeps) view.View {
	return view.ViewFunc(func(ctx context.Context, viewCtx *view.ViewContext) view.ViewResult {
		...
		if !perms.Can("supplier_contract_price_schedule", "list") {
			return view.Forbidden("supplier_contract_price_schedule:list")
		}
		_ = perms
...
func scheduleColumns(l expenditure.SupplierContractPriceScheduleLabels) []types.TableColumn {
...
func buildTableRows(schedules []*scpspb.SupplierContractPriceSchedule, contractNames map[string]string, l expenditure.SupplierContractPriceScheduleLabels) []types.TableRow {
...
func scheduleStatusLabel(status string, l expenditure.SupplierContractPriceScheduleLabels) string {
	switch status {
	case "SUPPLIER_CONTRACT_PRICE_SCHEDULE_STATUS_SCHEDULED":
...
func statusPageTitle(l expenditure.SupplierContractPriceScheduleLabels, status string) string {
	switch status {
	case "SUPPLIER_CONTRACT_PRICE_SCHEDULE_STATUS_SCHEDULED":
