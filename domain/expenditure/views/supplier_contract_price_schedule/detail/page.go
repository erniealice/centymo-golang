...
func buildPageData(viewCtx *view.ViewContext, deps *DetailViewDeps, l expenditure.SupplierContractPriceScheduleLabels, schedule *scpspb.SupplierContractPriceSchedule, activeTab, id string) *PageData {
	startStr := ""
...
func buildLineItemTable(ctx context.Context, deps *DetailViewDeps, scheduleID string, l expenditure.SupplierContractPriceScheduleLabels) *types.TableConfig {
