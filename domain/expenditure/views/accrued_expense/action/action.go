...
import (
	...
	"github.com/erniealice/centymo-golang/domain/expenditure/views/accrued_expense/form"
)

// Deps holds dependencies for accrued_expense action handlers.
type Deps struct {
	Routes       expenditure.AccruedExpenseRoutes
	Labels       expenditure.AccruedExpenseLabels
...
func buildEmptyFormData(ctx context.Context, deps *Deps, l expenditure.AccruedExpenseLabels) *form.Data {
	fd := &form.Data{
		Labels:       l.Form,
