...
import (
	...
	"github.com/erniealice/centymo-golang/domain/expenditure/views/accrued_expense_settlement/form"
)
...
func buildEmptyFormData(ctx context.Context, deps *Deps, l expenditure.AccruedExpenseSettlementLabels) *form.Data {
	fd := &form.Data{
		Labels:       l,
