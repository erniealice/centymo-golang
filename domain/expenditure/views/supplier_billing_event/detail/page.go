...
func eventToMap(ev *supplierbillingeventpb.SupplierBillingEvent, l expenditure.SupplierBillingEventLabels, routes treasury.TreasuryAdvancesRoutes) map[string]any {
	status := ev.GetStatus()
