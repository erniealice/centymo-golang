...
import (
	...
	"github.com/erniealice/centymo-golang/domain/expenditure/views/supplier_contract_price_schedule_line/form"
)
...
func buildEmptyLineFormData(ctx context.Context, deps *Deps, l expenditure.SupplierContractPriceScheduleLabels) *form.Data {
	fd := &form.Data{
