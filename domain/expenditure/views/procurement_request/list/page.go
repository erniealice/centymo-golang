...
func procurementRequestColumns(l expenditure.ProcurementRequestLabels) []types.TableColumn {
...
func buildTableRows(requests []*procurementrequestpb.ProcurementRequest, l expenditure.ProcurementRequestLabels) []types.TableRow {
	rows := []types.TableRow{}
...
func statusBadgeLabel(l expenditure.ProcurementRequestLabels, status string) string {
	switch status {
...
func statusPageTitle(l expenditure.ProcurementRequestLabels, status string) string {
	switch status {
	case "PROCUREMENT_REQUEST_STATUS_DRAFT":
