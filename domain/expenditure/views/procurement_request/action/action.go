...
import (
	...
	"github.com/erniealice/centymo-golang/domain/expenditure/views/procurement_request/form"
)
...
func buildEmptyFormData(ctx context.Context, deps *Deps, l expenditure.ProcurementRequestLabels) *form.Data {
	fd := &form.Data{
		Labels:       l.Form,
