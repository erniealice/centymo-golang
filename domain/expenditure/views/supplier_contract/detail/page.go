...
type DetailViewDeps struct {
	Routes       expenditure.SupplierContractRoutes
...
func buildLineItemTable(ctx context.Context, deps *DetailViewDeps, contractID string, l expenditure.SupplierContractLabels) *types.TableConfig {
	cIDPtr := contractID
...
func buildLinkedPOTable(ctx context.Context, deps *DetailViewDeps, contractID string, l expenditure.SupplierContractLabels) *types.TableConfig {
...
func buildLinkedExpTable(ctx context.Context, deps *DetailViewDeps, contractID string, l expenditure.SupplierContractLabels) *types.TableConfig {
...
func buildPriceScheduleTable(ctx context.Context, deps *DetailViewDeps, contractID string, l expenditure.SupplierContractLabels) *types.TableConfig {
	cIDPtr := contractID
	resp, err := deps.ListSupplierContractPriceSchedules(ctx, &scpspb.ListSupplierContractPriceSchedulesRequest{
		SupplierContractId: &cIDPtr,
	})
