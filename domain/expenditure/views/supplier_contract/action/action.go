...
import (
	...
	"github.com/erniealice/centymo-golang/domain/expenditure/views/supplier_contract/form"
)
...
func buildEmptyFormData(ctx context.Context, deps *Deps, l expenditure.SupplierContractLabels) *form.Data {
	fd := &form.Data{
		Labels:       l.Form,
