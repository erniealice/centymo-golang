...
import (
	...
	"github.com/erniealice/centymo-golang/domain/expenditure/views/supplier_contract_line/form"
)
...
func buildEmptyLineFormData(ctx context.Context, deps *Deps, l expenditure.SupplierContractLabels) *form.Data {
	fd := &form.Data{
		Labels:       l,
