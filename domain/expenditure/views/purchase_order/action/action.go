...
import (
	...
	poform "github.com/erniealice/centymo-golang/domain/expenditure/views/purchase_order/form"
...
func formLabels(l expenditure.ExpenditureLabels) poform.Labels {
	return poform.Labels{
		...
		// Info fields sourced from expenditure.PurchaseOrderFormLabels (populated from lyngua JSON + defaults).
