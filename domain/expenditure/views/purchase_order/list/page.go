...
func purchaseOrderColumns() []types.TableColumn {
	return []types.TableColumn{
		...
		{Key: "total_amount", Label: "Total Amount", WidthClass: "col-3xl", Align: "right"},
		{Key: "order_date", Label: "Order Date", WidthClass: "col-3xl"},
		{Key: "expected_delivery", Label: "Expected Delivery", WidthClass: "col-5xl"},
	}
}

func buildTableRows(orders []*purchaseorderpb.PurchaseOrder, l expenditure.ExpenditureLabels) []types.TableRow {
	rows := []types.TableRow{}
...
func statusPageTitle(l expenditure.ExpenditureLabels, status string) string {
	switch status {
	case "draft":
...
func statusEmptyTitle(l expenditure.ExpenditureLabels, status string) string {
	switch status {
	case "draft":
...
func statusEmptyMessage(l expenditure.ExpenditureLabels, status string) string {
	switch status {
	case "draft":
