...
func buildLineItemTable(items []map[string]any, tableLabels types.TableLabels, currency string, purchaseOrderID string, routes expenditure.ExpenditureRoutes, isDraft bool, perms *types.UserPermissions) *types.TableConfig {
