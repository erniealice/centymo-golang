...
// canonical label struct defined in package expenditure. Subsequent phases
...
// Labels is a package-local alias for expenditure.ExpenseRecognitionRunLabels.
...
type Labels = expenditure.ExpenseRecognitionRunLabels

// DefaultLabels is a package-local alias for
// expenditure.DefaultExpenseRecognitionRunLabels. Composition wiring in
// apps/service-admin calls this to seed defaults before lyngua overlay.
var DefaultLabels = expenditure.DefaultExpenseRecognitionRunLabels
