...
import (
	...
	queueform "github.com/erniealice/centymo-golang/domain/expenditure/views/expense_recognition_run/queue/form"
...
func queueColumns(l expenditure.ExpenseRecognitionRunLabels) []types.TableColumn {
	lc := l.Queue.Columns
...
func buildTableRows(
	...
	l expenditure.ExpenseRecognitionRunLabels,
