...
import (
	...
	detailform "github.com/erniealice/centymo-golang/domain/expenditure/views/expense_recognition_run/detail/form"
...
func buildTabItems(l expenditure.ExpenseRecognitionRunLabels, id string, routes expenditure.ExpenseRecognitionRunRoutes) []pyeza.TabItem {
...
func buildSelectionsTable(attempts []errshared.ExpenseRecognitionRunAttemptRow, l expenditure.ExpenseRecognitionRunLabels, tableLabels types.TableLabels) *types.TableConfig {
...
func buildResultsTable(attempts []errshared.ExpenseRecognitionRunAttemptRow, l expenditure.ExpenseRecognitionRunLabels, tableLabels types.TableLabels) *types.TableConfig {
	lr := l.Detail.Results
	columns := []types.TableColumn{
...
func buildBillsTable(rows []errshared.ExpenditureRow, l expenditure.ExpenseRecognitionRunLabels, tableLabels types.TableLabels) *types.TableConfig {
	lb := l.Detail.Bills
	columns := []types.TableColumn{
...
func buildRecognitionsTable(rows []errshared.ExpenseRecognitionRow, l expenditure.ExpenseRecognitionRunLabels, tableLabels types.TableLabels) *types.TableConfig {
...
func outcomeCell(l expenditure.ExpenseRecognitionRunLabels, outcome string) (label, variant string) {
	switch outcome {
	case "created":
...
func sourceKindLabel(l expenditure.ExpenseRecognitionRunLabels, kind string) string {
	switch kind {
