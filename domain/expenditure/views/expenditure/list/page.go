...
func expenditureColumns(l expenditure.ExpenditureLabels, expenditureType string) []types.TableColumn {
...
func buildTableRows(expenditures []*expenditurepb.Expenditure, l expenditure.ExpenditureLabels, expenditureType string) []types.TableRow {
	rows := []types.TableRow{}
...
func statusPageTitle(l expenditure.ExpenditureLabels, expType, status string) string {
	if expType == "purchase" {
		switch status {
		case "draft":
...
func statusPageCaption(l expenditure.ExpenditureLabels, expType, status string) string {
	if expType == "purchase" {
...
func statusEmptyTitle(l expenditure.ExpenditureLabels, expType, status string) string {
	if expType == "purchase" {
		switch status {
		case "draft":
...
func statusEmptyMessage(l expenditure.ExpenditureLabels, expType, status string) string {
	if expType == "purchase" {
		switch status {
		case "draft":
