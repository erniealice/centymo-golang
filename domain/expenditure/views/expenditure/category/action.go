...
import (
	...
	categoryform "github.com/erniealice/centymo-golang/domain/expenditure/views/expenditure/category/form"
...
func formLabels(l expenditure.ExpenditureCategoryLabels) categoryform.Labels {
	code := l.Form.Code
	name := l.Form.Name
	...
	return categoryform.Labels{
		...
		Name:        name,
		Description: description,
		// Info fields sourced from expenditure.ExpenditureCategoryFormLabels (populated from lyngua JSON + defaults).
...
func errLabels(l expenditure.ExpenditureLabels) expenditure.ExpenditureCategoryErrorLabels {
	e := l.Category.Errors
