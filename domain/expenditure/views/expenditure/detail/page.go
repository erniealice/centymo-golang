...
func buildTabItems(l expenditure.ExpenditureLabels, id string, routes expenditure.ExpenditureRoutes) []pyeza.TabItem {
...
func buildLineItemTable(items []map[string]any, l expenditure.ExpenditureLabels, tableLabels types.TableLabels, currency string, expenditureID string, routes expenditure.ExpenditureRoutes, perms *types.UserPermissions) *types.TableConfig {
