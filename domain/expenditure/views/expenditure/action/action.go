...
import (
	...
	expenditureform "github.com/erniealice/centymo-golang/domain/expenditure/views/expenditure/form"
...
func formLabels(l expenditure.ExpenditureLabels) expenditureform.Labels {
