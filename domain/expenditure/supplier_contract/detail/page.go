...
type DetailViewDeps struct {
	Routes       supplier_contract.Routes
	Labels       supplier_contract.Labels
...
func buildLineItemTable(ctx context.Context, deps *DetailViewDeps, contractID string, l supplier_contract.Labels) *types.TableConfig {
	cIDPtr := contractID
...
func buildLinkedPOTable(ctx context.Context, deps *DetailViewDeps, contractID string, l supplier_contract.Labels) *types.TableConfig {
...
func buildLinkedExpTable(ctx context.Context, deps *DetailViewDeps, contractID string, l supplier_contract.Labels) *types.TableConfig {
...
func buildPriceScheduleTable(ctx context.Context, deps *DetailViewDeps, contractID string, l supplier_contract.Labels) *types.TableConfig {
	cIDPtr := contractID
	resp, err := deps.ListSupplierContractPriceSchedules(ctx, &scpspb.ListSupplierContractPriceSchedulesRequest{
		SupplierContractId: &cIDPtr,
	})
