...
import (
	...
	"github.com/erniealice/centymo-golang/domain/expenditure/supplier_contract/form"
)
...
func buildEmptyFormData(ctx context.Context, deps *Deps, l supplier_contract.Labels) *form.Data {
	fd := &form.Data{
		Labels:       l.Form,
	...
	fd.KindOptions = []form.KindOption{
