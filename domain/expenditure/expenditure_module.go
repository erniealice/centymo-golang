...
import (
	...
	expendituredetail "github.com/erniealice/centymo-golang/domain/expenditure/expenditure/detail"
	expenseboard "github.com/erniealice/centymo-golang/domain/expenditure/expenditure/expense_dashboard"
	expenditurelist "github.com/erniealice/centymo-golang/domain/expenditure/expenditure/list"
...
// PaymentTermOption is re-exported from action for use by callers wiring ExpenditureModuleDeps.
...
// ExpenditureModule holds all constructed expenditure views.
type ExpenditureModule struct {
	routes            epkg.Routes
...
// NewExpenditureModule creates the expenditure module with purchase and expense views.
func NewExpenditureModule(deps *ExpenditureModuleDeps) *ExpenditureModule {
...
func (m *ExpenditureModule) RegisterRoutes(r view.RouteRegistrar) {
