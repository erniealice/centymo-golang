...
import (
	...
	purchaseorderlist "github.com/erniealice/centymo-golang/domain/expenditure/purchase_order/list"
	purchaseorderreceipt "github.com/erniealice/centymo-golang/domain/expenditure/purchase_order/receipt"
)
...
// NewPurchaseOrderModule creates the purchase order module views.
func NewPurchaseOrderModule(deps *PurchaseOrderModuleDeps) *PurchaseOrderModule {
	m := &PurchaseOrderModule{
		routes: deps.Routes,
	}
...
func (m *PurchaseOrderModule) RegisterRoutes(r view.RouteRegistrar) {
