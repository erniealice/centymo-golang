...
import (
	...
	queueform "github.com/erniealice/centymo-golang/domain/expenditure/expense_recognition_run/queue/form"
...
func queueColumns(l expense_recognition_run.Labels) []types.TableColumn {
	lc := l.Queue.Columns
...
func buildTableRows(
	...
	l expense_recognition_run.Labels,
