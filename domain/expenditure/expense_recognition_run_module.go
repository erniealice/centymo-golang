...
// ---------------------------------------------------------------------------
// ExpenseRecognitionRunModuleDeps — typed callbacks; no espyna/proto types cross this boundary.
// ---------------------------------------------------------------------------

// ExpenseRecognitionRunModuleDeps holds all dependencies for the expense-recognition-run view module.
type ExpenseRecognitionRunModuleDeps struct {
	Routes       epkg.Routes
	Labels       epkg.Labels
...
// ExpenseRecognitionRunModule holds all constructed expense-recognition-run views.
type ExpenseRecognitionRunModule struct {
	routes epkg.Routes
	// Surface D.
	List      view.View
	Table     view.View
...
// NewExpenseRecognitionRunModule constructs the expense-recognition-run module from the deps.
func NewExpenseRecognitionRunModule(deps *ExpenseRecognitionRunModuleDeps) *ExpenseRecognitionRunModule {
	...
	return &ExpenseRecognitionRunModule{
		routes:             deps.Routes,
...
func (m *ExpenseRecognitionRunModule) RegisterRoutes(r view.RouteRegistrar) {
