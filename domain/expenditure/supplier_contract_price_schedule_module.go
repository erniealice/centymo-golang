...
//	    deps := &supplier_contract_price_schedule.SupplierContractPriceScheduleModuleDeps{ ... }
//	    mod := supplier_contract_price_schedule.NewSupplierContractPriceScheduleModule(deps)
...
import (
	...
	scpsaction "github.com/erniealice/centymo-golang/domain/expenditure/supplier_contract_price_schedule/action"
	scpsdetail "github.com/erniealice/centymo-golang/domain/expenditure/supplier_contract_price_schedule/detail"
	scpslist "github.com/erniealice/centymo-golang/domain/expenditure/supplier_contract_price_schedule/list"
	...
	epkg "github.com/erniealice/centymo-golang/domain/expenditure/supplier_contract_price_schedule"
	pyeza "github.com/erniealice/pyeza-golang"
	"github.com/erniealice/pyeza-golang/types"
	"github.com/erniealice/pyeza-golang/view"
)

// SupplierContractPriceScheduleModuleDeps holds all dependencies for the supplier_contract_price_schedule module.
type SupplierContractPriceScheduleModuleDeps struct {
	Routes       epkg.Routes
	Labels       epkg.Labels
...
// SupplierContractPriceScheduleModule holds all constructed supplier_contract_price_schedule views.
type SupplierContractPriceScheduleModule struct {
	routes epkg.Routes
...
// NewSupplierContractPriceScheduleModule creates the supplier_contract_price_schedule module with all
// views wired.
func NewSupplierContractPriceScheduleModule(deps *SupplierContractPriceScheduleModuleDeps) *SupplierContractPriceScheduleModule {
	...
	m := &SupplierContractPriceScheduleModule{
		routes:        deps.Routes,
...
func (m *SupplierContractPriceScheduleModule) RegisterRoutes(r view.RouteRegistrar) {
