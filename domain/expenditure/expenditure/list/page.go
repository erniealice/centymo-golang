...
func expenditureColumns(l expenditure.Labels, expenditureType string) []types.TableColumn {
...
func statusPageTitle(l expenditure.Labels, expType, status string) string {
	if expType == "purchase" {
		switch status {
		case "draft":
...
func statusPageCaption(l expenditure.Labels, expType, status string) string {
	if expType == "purchase" {
...
func statusEmptyTitle(l expenditure.Labels, expType, status string) string {
	if expType == "purchase" {
		switch status {
		case "draft":
...
func statusEmptyMessage(l expenditure.Labels, expType, status string) string {
	if expType == "purchase" {
		switch status {
		case "draft":
