	...
	return view.ViewFunc(func(ctx context.Context, viewCtx *view.ViewContext) view.ViewResult {
		...
		dash := types.DashboardData{
			...
			Stats: []types.StatCardData{
				...
				{Icon: "icon-check-circle", Value: types.FormatMoneyCompact(resp.Stats.ApprovedMTD, currency), Label: l.StatApprovedMTD, Color: "sage", TestID: "expense-stat-approved"},
				{Icon: "icon-credit-card", Value: types.FormatMoneyCompact(resp.Stats.ReimbursableMTD, currency), Label: l.StatReimbursable, Color: "terracotta", TestID: "expense-stat-reimbursable"},
			...
			Widgets: []types.DashboardWidget{
				...
				},
				{
					...
					Custom: renderTopCategoriesTable(topCats, l, currency),
				},
				{
					ID:    "recent",
...
func renderTopCategoriesTable(rows []catRow, l expenditure.ExpenseDashboardLabels, currency string) template.HTML {
	if len(rows) == 0 {
