...
func buildLineItemTable(items []map[string]any, l expenditure.Labels, tableLabels types.TableLabels, currency string, expenditureID string, routes expenditure.Routes, perms *types.UserPermissions) *types.TableConfig {
