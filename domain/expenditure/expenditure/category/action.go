...
import (
	...
	categoryform "github.com/erniealice/centymo-golang/domain/expenditure/expenditure/category/form"
...
func formLabels(l expenditure.CategoryLabels) categoryform.Labels {
	code := l.Form.Code
	name := l.Form.Name
	...
	return categoryform.Labels{
		...
		Name:        name,
		Description: description,
		// Info fields sourced from expenditure.CategoryFormLabels (populated from lyngua JSON + defaults).
...
func errLabels(l expenditure.Labels) expenditure.CategoryErrorLabels {
	e := l.Category.Errors
