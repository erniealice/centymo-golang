...
import (
	...
	costplanlineform "github.com/erniealice/centymo-golang/domain/procurement/views/cost_plan/form"
...
type CostPlanLineDeps struct {
	...
	Labels         procurement.SupplierProductCostPlanLabels
...
// buildCostPlanLineFormLabels converts procurement.SupplierProductCostPlanLabels
// into costplanlineform.CostPlanLineLabels.
func buildCostPlanLineFormLabels(l procurement.SupplierProductCostPlanLabels) costplanlineform.CostPlanLineLabels {
