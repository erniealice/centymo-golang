...
import (
	...
	"github.com/erniealice/centymo-golang/domain/procurement/views/cost_plan/form"
...
// buildFormLabels converts procurement.CostPlanLabels into form.Labels.
func buildFormLabels(l procurement.CostPlanLabels) form.Labels {
	return form.Labels{
