...
type ListViewDeps struct {
	Routes                  procurement.CostPlanRoutes
	...
	Labels                  procurement.CostPlanLabels
...
func costPlanColumns(l procurement.CostPlanLabels) []types.TableColumn {
...
func buildTableRows(plans []*costplanpb.CostPlan, status string, l procurement.CostPlanLabels, routes procurement.CostPlanRoutes, perms *types.UserPermissions) []types.TableRow {
	rows := []types.TableRow{}
...
func statusTitle(l procurement.CostPlanLabels, status string) string {
	switch status {
	case "active":
