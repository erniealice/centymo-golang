...
import (
	...
	"github.com/erniealice/centymo-golang/domain/procurement/views/supplier_plan/form"
...
// buildFormLabels converts procurement.SupplierPlanLabels into form.Labels.
func buildFormLabels(l procurement.SupplierPlanLabels) form.Labels {
	return form.Labels{
