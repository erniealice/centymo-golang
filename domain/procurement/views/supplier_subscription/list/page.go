...
type ListViewDeps struct {
	Routes                              procurement.SupplierSubscriptionRoutes
	...
	Labels                              procurement.SupplierSubscriptionLabels
...
func supplierSubscriptionColumns(l procurement.SupplierSubscriptionLabels) []types.TableColumn {
...
func buildTableRows(ctx context.Context, subscriptions []*suppliersubscriptionpb.SupplierSubscription, status string, l procurement.SupplierSubscriptionLabels, routes procurement.SupplierSubscriptionRoutes, perms *types.UserPermissions) []types.TableRow {
...
func statusTitle(l procurement.SupplierSubscriptionLabels, status string) string {
	switch status {
	case "active":
...
func statusSubtitle(l procurement.SupplierSubscriptionLabels, status string) string {
