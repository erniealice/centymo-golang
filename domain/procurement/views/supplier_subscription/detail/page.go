...
// it from either procurement.SupplierSubscriptionLabels (Buttons.RecognizeExpense)
...
func buildTabs(l procurement.SupplierSubscriptionLabels, routes procurement.SupplierSubscriptionRoutes, id string, activeTab string) []pyeza.TabItem {
