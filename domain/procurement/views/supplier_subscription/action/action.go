...
import (
	...
	"github.com/erniealice/centymo-golang/domain/procurement/views/supplier_subscription/form"
...
// buildFormLabels converts procurement.SupplierSubscriptionLabels into form.Labels.
func buildFormLabels(l procurement.SupplierSubscriptionLabels) form.Labels {
	return form.Labels{
