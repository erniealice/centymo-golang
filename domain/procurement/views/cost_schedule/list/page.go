...
type ListViewDeps struct {
	Routes                      procurement.CostScheduleRoutes
	...
	Labels                      procurement.CostScheduleLabels
...
func costScheduleColumns(l procurement.CostScheduleLabels) []types.TableColumn {
...
func buildTableRows(ctx context.Context, schedules []*costschedulepb.CostSchedule, status string, l procurement.CostScheduleLabels, routes procurement.CostScheduleRoutes, perms *types.UserPermissions) []types.TableRow {
...
func statusTitle(l procurement.CostScheduleLabels, status string) string {
	switch status {
	case "active":
