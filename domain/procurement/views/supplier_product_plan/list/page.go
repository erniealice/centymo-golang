...
type ListViewDeps struct {
	Routes                             procurement.SupplierProductPlanRoutes
	...
	Labels                             procurement.SupplierProductPlanLabels
...
func NewView(deps *ListViewDeps) view.View {
	return view.ViewFunc(func(ctx context.Context, viewCtx *view.ViewContext) view.ViewResult {
		...
		if !perms.Can("supplier_product_plan", "list") {
			return view.Forbidden("supplier_product_plan:list")
		}
		_ = perms
...
func supplierProductPlanColumns(l procurement.SupplierProductPlanLabels) []types.TableColumn {
...
func buildTableRows(plans []*supplierproductplanpb.SupplierProductPlan, status string, l procurement.SupplierProductPlanLabels, routes procurement.SupplierProductPlanRoutes, perms *types.UserPermissions) []types.TableRow {
	rows := []types.TableRow{}
...
func statusTitle(l procurement.SupplierProductPlanLabels, status string) string {
	switch status {
	case "active":
