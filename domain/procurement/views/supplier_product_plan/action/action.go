...
import (
	...
	"github.com/erniealice/centymo-golang/domain/procurement/views/supplier_product_plan/form"
...
// buildFormLabels converts procurement.SupplierProductPlanLabels into form.Labels.
func buildFormLabels(l procurement.SupplierProductPlanLabels) form.Labels {
	return form.Labels{
