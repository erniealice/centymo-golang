...
import (
	...
	supplierplanaction "github.com/erniealice/centymo-golang/domain/procurement/supplier_plan/action"
	supplierplandetail "github.com/erniealice/centymo-golang/domain/procurement/supplier_plan/detail"
	supplierplanlist "github.com/erniealice/centymo-golang/domain/procurement/supplier_plan/list"

	pyeza "github.com/erniealice/pyeza-golang"
	"github.com/erniealice/pyeza-golang/types"
	"github.com/erniealice/pyeza-golang/view"

	epkg "github.com/erniealice/centymo-golang/domain/procurement/supplier_plan"
	supplierplanpb "github.com/erniealice/esqyma/pkg/schema/v1/domain/procurement/supplier_plan"
)

// SupplierPlanModuleDeps holds all dependencies for the supplier_plan module.
type SupplierPlanModuleDeps struct {
	Routes       epkg.Routes
	Labels       epkg.Labels
...
// SupplierPlanModule holds all constructed supplier_plan views.
type SupplierPlanModule struct {
	routes        epkg.Routes
	Dashboard     view.View
	List          view.View
	Table         view.View
...
// NewSupplierPlanModule creates the supplier_plan module with all views wired.
func NewSupplierPlanModule(deps *SupplierPlanModuleDeps) *SupplierPlanModule {
...
func (m *SupplierPlanModule) RegisterRoutes(r view.RouteRegistrar) {
