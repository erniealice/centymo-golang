...
// it from either supplier_subscription.Labels (Buttons.RecognizeExpense)
// or sib_expenditure_expense_recognition_run.Labels (Actions.RunRecognitions).
...
func buildTabs(l supplier_subscription.Labels, routes supplier_subscription.Routes, id string, activeTab string) []pyeza.TabItem {
