...
import (
	...
	"github.com/erniealice/centymo-golang/domain/procurement/supplier_subscription/form"
...
// buildFormLabels converts supplier_subscription.Labels into form.Labels.
func buildFormLabels(l supplier_subscription.Labels) form.Labels {
	return form.Labels{
