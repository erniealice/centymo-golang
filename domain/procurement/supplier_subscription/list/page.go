...
type ListViewDeps struct {
	Routes                              supplier_subscription.Routes
	...
	Labels                              supplier_subscription.Labels
...
func supplierSubscriptionColumns(l supplier_subscription.Labels) []types.TableColumn {
...
func buildTableRows(ctx context.Context, subscriptions []*suppliersubscriptionpb.SupplierSubscription, status string, l supplier_subscription.Labels, routes supplier_subscription.Routes, perms *types.UserPermissions) []types.TableRow {
...
func statusTitle(l supplier_subscription.Labels, status string) string {
	switch status {
	case "active":
...
func statusSubtitle(l supplier_subscription.Labels, status string) string {
