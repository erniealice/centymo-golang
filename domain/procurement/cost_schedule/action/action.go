...
import (
	...
	"github.com/erniealice/centymo-golang/domain/procurement/cost_schedule/form"
...
// buildFormLabels converts cost_schedule.Labels into form.Labels.
func buildFormLabels(l cost_schedule.Labels) form.Labels {
	return form.Labels{
