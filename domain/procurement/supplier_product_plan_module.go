...
import (
	...
	supplierproductplanaction "github.com/erniealice/centymo-golang/domain/procurement/supplier_product_plan/action"
	supplierproductplandetail "github.com/erniealice/centymo-golang/domain/procurement/supplier_product_plan/detail"
	supplierproductplanlist "github.com/erniealice/centymo-golang/domain/procurement/supplier_product_plan/list"

	pyeza "github.com/erniealice/pyeza-golang"
	"github.com/erniealice/pyeza-golang/types"
	"github.com/erniealice/pyeza-golang/view"

	epkg "github.com/erniealice/centymo-golang/domain/procurement/supplier_product_plan"
	supplierproductplanpb "github.com/erniealice/esqyma/pkg/schema/v1/domain/procurement/supplier_product_plan"
)

// SupplierProductPlanModuleDeps holds all dependencies for the supplier_product_plan module.
type SupplierProductPlanModuleDeps struct {
	Routes       epkg.Routes
	Labels       epkg.Labels
...
// SupplierProductPlanModule holds all constructed supplier_product_plan views.
type SupplierProductPlanModule struct {
	routes        epkg.Routes
	Dashboard     view.View
	List          view.View
	Table         view.View
...
// NewSupplierProductPlanModule creates the supplier_product_plan module with all views wired.
func NewSupplierProductPlanModule(deps *SupplierProductPlanModuleDeps) *SupplierProductPlanModule {
	...
	return &SupplierProductPlanModule{
		routes:        deps.Routes,
		Dashboard:     listView,
		List:          listView,
		Table:         tableView,
...
func (m *SupplierProductPlanModule) RegisterRoutes(r view.RouteRegistrar) {
