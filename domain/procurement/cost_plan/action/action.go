...
import (
	...
	"github.com/erniealice/centymo-golang/domain/procurement/cost_plan/form"
...
// buildFormLabels converts cost_plan.Labels into form.Labels.
func buildFormLabels(l cost_plan.Labels) form.Labels {
	return form.Labels{
