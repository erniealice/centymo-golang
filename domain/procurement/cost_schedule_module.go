...
import (
	...
	costscheduleaction "github.com/erniealice/centymo-golang/domain/procurement/cost_schedule/action"
	costscheduledetail "github.com/erniealice/centymo-golang/domain/procurement/cost_schedule/detail"
	costschedulelist "github.com/erniealice/centymo-golang/domain/procurement/cost_schedule/list"

	pyeza "github.com/erniealice/pyeza-golang"
	"github.com/erniealice/pyeza-golang/types"
	"github.com/erniealice/pyeza-golang/view"

	epkg "github.com/erniealice/centymo-golang/domain/procurement/cost_schedule"
	costschedulepb "github.com/erniealice/esqyma/pkg/schema/v1/domain/procurement/cost_schedule"
)

// CostScheduleModuleDeps holds all dependencies for the cost_schedule module.
type CostScheduleModuleDeps struct {
	Routes       epkg.Routes
	Labels       epkg.Labels
...
// CostScheduleModule holds all constructed cost_schedule views.
type CostScheduleModule struct {
	routes        epkg.Routes
	Dashboard     view.View
	List          view.View
	Table         view.View
...
// NewCostScheduleModule creates the cost_schedule module with all views wired.
func NewCostScheduleModule(deps *CostScheduleModuleDeps) *CostScheduleModule {
...
func (m *CostScheduleModule) RegisterRoutes(r view.RouteRegistrar) {
