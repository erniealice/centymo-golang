...
import (
	...
	epkg "github.com/erniealice/centymo-golang/domain/procurement/supplier_subscription"
...
// SupplierSubscriptionModuleDeps holds all dependencies for the supplier_subscription module.
type SupplierSubscriptionModuleDeps struct {
	Routes       epkg.Routes
	Labels       epkg.Labels
...
// SupplierSubscriptionModule holds all constructed supplier_subscription views.
type SupplierSubscriptionModule struct {
	routes           epkg.Routes
	Dashboard        view.View
	List             view.View
	Table            view.View
...
// NewSupplierSubscriptionModule creates the supplier_subscription module with all views wired.
func NewSupplierSubscriptionModule(deps *SupplierSubscriptionModuleDeps) *SupplierSubscriptionModule {
	...
	return &SupplierSubscriptionModule{
		routes:           deps.Routes,
		Dashboard:        listView,
		List:             listView,
		Table:            tableView,
...
func (m *SupplierSubscriptionModule) RegisterRoutes(r view.RouteRegistrar) {
