...
func NewSetStatusAction(setActive func(ctx context.Context, id string, active bool) error, labels inventory.Labels) view.View {
...
func NewBulkSetStatusAction(setActive func(ctx context.Context, id string, active bool) error, labels inventory.Labels) view.View {
	return view.ViewFunc(func(ctx context.Context, viewCtx *view.ViewContext) view.ViewResult {
		perms := view.GetUserPermissions(ctx)
		if !perms.Can("inventory_item", "update") {
			return view.HTMXError(labels.Errors.PermissionDenied)
