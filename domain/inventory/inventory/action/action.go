...
import (
	...
	inventoryform "github.com/erniealice/centymo-golang/domain/inventory/inventory/form"
...
func formLabels(t func(string) string, f inventory.FormLabels) inventoryform.Labels {
