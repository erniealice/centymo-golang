...
func buildTabItems(l inventory.Labels, id string, isSerialized bool, routes inventory.Routes) []pyeza.TabItem {
...
func trackingModeDisplayLabel(trackingMode string, l inventory.Labels) string {
	switch trackingMode {
	case "none":
...
func buildSerialTable(serials []*inventoryserialpb.InventorySerial, l inventory.Labels, tableLabels types.TableLabels, inventoryItemID string, routes inventory.Routes, perms *types.UserPermissions) *types.TableConfig {
...
func buildTransactionTable(ctx context.Context, deps *DetailViewDeps, inventoryItemID string, l inventory.Labels, tableLabels types.TableLabels, routes inventory.Routes, perms *types.UserPermissions) *types.TableConfig {
...
func loadDepreciation(ctx context.Context, deps *DetailViewDeps, inventoryItemID string, l inventory.Labels) *DepreciationInfo {
...
func depreciationMethodLabel(method string, l inventory.Labels) string {
	switch method {
	case "straight_line":
...
func buildAuditTable(l inventory.Labels, tableLabels types.TableLabels) *types.TableConfig {
	columns := []types.TableColumn{
