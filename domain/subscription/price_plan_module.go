...
// PricePlanModuleDeps holds all dependencies for the price_plan module.
...
// NewPricePlanModule creates the price_plan module with all views wired.
func NewPricePlanModule(deps *PricePlanModuleDeps) *PricePlanModule {
...
func (m *PricePlanModule) RegisterRoutes(r view.RouteRegistrar) {
