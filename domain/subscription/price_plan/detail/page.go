...
func buildTabItems(id string, l price_plan.Labels, productPriceCount int, routes price_plan.Routes) []pyeza.TabItem {
...
func formatBillingKind(kind string, l price_plan.FormLabels) string {
	switch kind {
...
func formatAmountBasis(basis string, l price_plan.FormLabels) string {
	switch basis {
...
func pickSummaryCell(kind, basis string, s price_plan.BillingSummaryCopy) price_plan.SummaryLines {
	var byBasis price_plan.SummaryByBasis
	switch kind {
	case "BILLING_KIND_ONE_TIME":
		byBasis = s.OneTime
	case "BILLING_KIND_RECURRING":
	...
	case "BILLING_KIND_AD_HOC":
		byBasis = s.AdHoc
	default:
		return price_plan.SummaryLines{}
	}
	switch basis {
	case "AMOUNT_BASIS_PER_CYCLE":
