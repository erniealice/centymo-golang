...
func FormatBillingKindLabel(kind string, l subscription.PricePlanFormLabels) string {
	switch kind {
...
func FormatAmountBasisLabel(basis string, l subscription.PricePlanFormLabels) string {
	switch basis {
...
func BillingTreatmentDisplay(value string, l subscription.ProductPricePlanFormLabels) string {
	switch value {
