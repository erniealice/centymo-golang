...
type Deps struct {
	...
	ScheduleDetailLabels   subscription.PriceScheduleDetailLabels
...
type productPriceFormData struct {
	...
	// Labels.
	ProductPricePlanLabels subscription.ProductPricePlanFormLabels
	PriceScheduleLabels    subscription.PriceScheduleDetailLabels
