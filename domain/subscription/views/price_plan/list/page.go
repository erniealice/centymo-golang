...
func pricePlanColumns(l subscription.PricePlanLabels) []types.TableColumn {
...
func buildTableRows(pricePlans []*priceplanpb.PricePlan, status string, l subscription.PricePlanLabels, cl pyeza.CommonLabels, routes subscription.PricePlanRoutes, inUseIDs map[string]bool, perms *types.UserPermissions, planNames, scheduleNames map[string]string, durationLabels pyeza.DurationUnitLabels) []types.TableRow {
	rows := []types.TableRow{}
...
func statusPageTitle(l subscription.PricePlanLabels, status string) string {
	switch status {
	case "active":
...
func statusPageCaption(l subscription.PricePlanLabels, status string) string {
	switch status {
	case "active":
...
func statusEmptyTitle(l subscription.PricePlanLabels, status string) string {
	return l.Empty.Title
}

func statusEmptyMessage(l subscription.PricePlanLabels, status string) string {
