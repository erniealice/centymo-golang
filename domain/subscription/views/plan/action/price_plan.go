...
type PricePlanDeps struct {
	...
	PriceScheduleLabels subscription.PriceScheduleLabels
...
func buildScheduleAutoHint(formLabels subscription.PricePlanFormLabels, mode, scheduleID, clientName string) string {
	if mode != "readonly" {
		return ""
	}
