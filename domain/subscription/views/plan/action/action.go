...
import (
	...
	"github.com/erniealice/centymo-golang/domain/subscription/views/plan/form"
...
// buildFormLabels maps subscription.PlanLabels fields to form.Labels.
...
func buildFormLabels(l subscription.PlanLabels) form.Labels {
	return form.Labels{
		Name:            l.Form.Name,
		...
		// Info fields sourced from subscription.PlanFormLabels (populated from lyngua JSON + defaults).
