...
// productPlanFormLabels converts subscription.ProductPlanFormLabels into the local type.
func productPlanFormLabels(l subscription.ProductPlanFormLabels) ProductPlanFormLabels {
...
func buildKindOptions(l subscription.ProductKindOptionLabels) []KindOption {
	return []KindOption{
