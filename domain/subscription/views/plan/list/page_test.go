...
func testPlanLabels() subscription.PlanLabels {
	l := subscription.DefaultPlanLabels()
...
func testPlanRoutes() subscription.PlanRoutes {
	return subscription.DefaultPlanRoutes()
}
