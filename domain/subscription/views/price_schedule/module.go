...
import (
	...
	pricescheduleaction "github.com/erniealice/centymo-golang/domain/subscription/views/price_schedule/action"
	pricescheduledetail "github.com/erniealice/centymo-golang/domain/subscription/views/price_schedule/detail"
	priceschedulePlan "github.com/erniealice/centymo-golang/domain/subscription/views/price_schedule/detail/plan"
	priceschedulelist "github.com/erniealice/centymo-golang/domain/subscription/views/price_schedule/list"
...
type ModuleDeps struct {
	...
	PricePlanLabels        subscription.PricePlanLabels        // used by the schedule-scoped price_plan detail page
	ProductPricePlanLabels subscription.ProductPricePlanLabels // used by the schedule-scoped plan detail product-prices tab
...
func pricePlanLabelsFromDeps(deps *ModuleDeps) subscription.PricePlanLabels {
	if deps.PricePlanLabels.Detail.Heading != "" || deps.PricePlanLabels.Tabs.Info != "" {
		return deps.PricePlanLabels
	}
	l := subscription.DefaultPricePlanLabels()
	l.Errors = subscription.PricePlanErrorLabels{
