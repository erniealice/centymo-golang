...
import (
	...
	"github.com/erniealice/centymo-golang/domain/subscription/views/price_plan/form"
...
type DetailViewDeps struct {
	...
	PricePlanLabels subscription.PricePlanLabels
...
func buildTabItems(id string, l subscription.PriceScheduleLabels, planCount int, routes subscription.PriceScheduleRoutes) []pyeza.TabItem {
...
func formatCadence(kind priceplanpb.BillingKind, cycle string, l subscription.PriceScheduleDetailLabels) string {
	switch kind {
...
func formatBillingKindLabel(kind priceplanpb.BillingKind, l subscription.PriceScheduleDetailLabels) string {
	switch kind {
	case priceplanpb.BillingKind_BILLING_KIND_ONE_TIME:
...
func formatAmountBasisLabel(basis priceplanpb.AmountBasis, l subscription.PriceScheduleDetailLabels) string {
	switch basis {
