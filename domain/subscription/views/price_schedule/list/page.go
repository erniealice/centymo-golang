...
type ListViewDeps struct {
	...
	Labels                   subscription.PriceScheduleLabels
...
func NewView(deps *ListViewDeps) view.View {
	return view.ViewFunc(func(ctx context.Context, viewCtx *view.ViewContext) view.ViewResult {
		...
		columns := priceScheduleColumns(deps.Labels)
...
func priceScheduleColumns(l subscription.PriceScheduleLabels) []types.TableColumn {
...
func buildTableRows(ctx context.Context, priceSchedules []*priceschedulepb.PriceSchedule, status string, l subscription.PriceScheduleLabels, cl pyeza.CommonLabels, routes subscription.PriceScheduleRoutes, inUseIDs map[string]bool, perms *types.UserPermissions, locationNames map[string]string, clientNames map[string]string) []types.TableRow {
...
func buildRowActions(id, name string, active, isInUse bool, l subscription.PriceScheduleLabels, cl pyeza.CommonLabels, routes subscription.PriceScheduleRoutes, perms *types.UserPermissions) []types.TableAction {
...
func buildBulkActions(l subscription.PriceScheduleLabels, cl pyeza.CommonLabels, status string, routes subscription.PriceScheduleRoutes) []types.BulkAction {
...
func statusPageTitle(l subscription.PriceScheduleLabels, status string) string {
	switch status {
	case "active":
...
func statusPageCaption(l subscription.PriceScheduleLabels, status string) string {
	return l.Page.Subtitle
}

func statusEmptyTitle(l subscription.PriceScheduleLabels, status string) string {
	return l.Empty.Title
}

func statusEmptyMessage(l subscription.PriceScheduleLabels, status string) string {
