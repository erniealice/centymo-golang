...
func testLabels() subscription.SubscriptionLabels {
	return subscription.SubscriptionLabels{
		Errors: subscription.SubscriptionErrorLabels{
...
func testRoutes() subscription.SubscriptionRoutes {
	return subscription.SubscriptionRoutes{
