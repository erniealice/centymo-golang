...
import (
	...
	"github.com/erniealice/centymo-golang/domain/subscription/views/subscription/form"
...
// buildFormLabels builds a form.Labels from subscription.SubscriptionLabels.
...
// subscription.SubscriptionLabels is a dependency-bearing type.
func buildFormLabels(l subscription.SubscriptionLabels) form.Labels {
	return form.Labels{
