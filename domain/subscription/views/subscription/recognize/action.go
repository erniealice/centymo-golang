...
import (
	...
	recognizeform "github.com/erniealice/centymo-golang/domain/subscription/views/subscription/recognize/form"
...
// buildLabels assembles the recognize drawer's flat Labels from subscription.SubscriptionLabels.
func buildLabels(l subscription.SubscriptionLabels) recognizeform.Labels {
...
func treatmentLabel(t string, labels subscription.SubscriptionLabels) string {
	switch t {
	case "recurring":
...
func statusLabel(s billingeventpb.BillingEventStatus, l subscription.SubscriptionMilestoneLabels) string {
	switch s {
