...
func subscriptionColumns(l subscription.SubscriptionLabels) []types.TableColumn {
...
func buildTableRows(ctx context.Context, subscriptions []*subscriptionpb.Subscription, status string, l subscription.SubscriptionLabels, routes subscription.SubscriptionRoutes, inUseIDs map[string]bool, perms *types.UserPermissions) []types.TableRow {
...
func statusTitle(l subscription.SubscriptionLabels, status string) string {
	switch status {
	case "active":
...
func statusSubtitle(l subscription.SubscriptionLabels, status string) string {
	switch status {
	case "active":
