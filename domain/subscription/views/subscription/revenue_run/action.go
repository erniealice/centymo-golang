...
import (
	...
	revenuerunform "github.com/erniealice/centymo-golang/domain/subscription/views/subscription/revenue_run/form"
)
...
func buildDrawerData(
	...
	l subscription.SubscriptionRevenueRunLabels,
	commonLabels pyeza.CommonLabels,
) *revenuerunform.Data {
