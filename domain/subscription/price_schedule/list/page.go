...
func priceScheduleColumns(l price_schedule.Labels) []types.TableColumn {
...
func buildTableRows(ctx context.Context, priceSchedules []*priceschedulepb.PriceSchedule, status string, l price_schedule.Labels, cl pyeza.CommonLabels, routes price_schedule.Routes, inUseIDs map[string]bool, perms *types.UserPermissions, locationNames map[string]string, clientNames map[string]string) []types.TableRow {
...
func buildRowActions(id, name string, active, isInUse bool, l price_schedule.Labels, cl pyeza.CommonLabels, routes price_schedule.Routes, perms *types.UserPermissions) []types.TableAction {
...
func buildBulkActions(l price_schedule.Labels, cl pyeza.CommonLabels, status string, routes price_schedule.Routes) []types.BulkAction {
...
func statusPageTitle(l price_schedule.Labels, status string) string {
	switch status {
	case "active":
...
func statusPageCaption(l price_schedule.Labels, status string) string {
	return l.Page.Subtitle
}

func statusEmptyTitle(l price_schedule.Labels, status string) string {
	return l.Empty.Title
}

func statusEmptyMessage(l price_schedule.Labels, status string) string {
