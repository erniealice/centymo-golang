...
func buildTabItems(id string, l price_schedule.Labels, planCount int, routes price_schedule.Routes) []pyeza.TabItem {
...
func formatCadence(kind priceplanpb.BillingKind, cycle string, l price_schedule.DetailLabels) string {
	switch kind {
...
func formatBillingKindLabel(kind priceplanpb.BillingKind, l price_schedule.DetailLabels) string {
	switch kind {
	case priceplanpb.BillingKind_BILLING_KIND_ONE_TIME:
...
func formatAmountBasisLabel(basis priceplanpb.AmountBasis, l price_schedule.DetailLabels) string {
	switch basis {
