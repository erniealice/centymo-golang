...
import (
	...
	epkg "github.com/erniealice/centymo-golang/domain/subscription/price_schedule"
...
// PriceScheduleModuleDeps holds all dependencies for the price_schedule module.
...
// PriceScheduleModule holds all constructed price_schedule views.
type PriceScheduleModule struct {
	routes        epkg.Routes
	Dashboard     view.View
	List          view.View
	Table         view.View
...
// NewPriceScheduleModule creates the price_schedule module with all views wired.
func NewPriceScheduleModule(deps *PriceScheduleModuleDeps) *PriceScheduleModule {
...
func (m *PriceScheduleModule) RegisterRoutes(r view.RouteRegistrar) {
