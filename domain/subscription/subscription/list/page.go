...
func subscriptionColumns(l subscription.Labels) []types.TableColumn {
...
func buildTableRows(ctx context.Context, subscriptions []*subscriptionpb.Subscription, status string, l subscription.Labels, routes subscription.Routes, inUseIDs map[string]bool, perms *types.UserPermissions) []types.TableRow {
...
func statusTitle(l subscription.Labels, status string) string {
	switch status {
	case "active":
...
func statusSubtitle(l subscription.Labels, status string) string {
	switch status {
	case "active":
