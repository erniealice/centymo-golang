...
type Deps struct {
	CreateOptions subscription.CreateOptions
...
// buildFormLabels builds a form.Labels from subscription.Labels.
...
// subscription.Labels is a dependency-bearing type.
func buildFormLabels(l subscription.Labels) form.Labels {
	return form.Labels{
		...
		EscalationSectionTitle:     l.Form.EscalationSectionTitle,
		EscalationMode:             l.Form.EscalationMode,
		EscalationUsePlanDefault:   l.Form.EscalationUsePlanDefault,
		EscalationNotRecorded:      l.Form.EscalationNotRecorded,
		EscalationNone:             l.Form.EscalationNone,
		EscalationFixedPercentage:  l.Form.EscalationFixedPercentage,
		EscalationScope:            l.Form.EscalationScope,
		EscalationWithinAgreement:  l.Form.EscalationWithinAgreement,
		EscalationOnRenewal:        l.Form.EscalationOnRenewal,
		EscalationRate:             l.Form.EscalationRate,
		EscalationFirstAfterMonths: l.Form.EscalationFirstAfterMonths,
		EscalationEveryMonths:      l.Form.EscalationEveryMonths,
		EscalationCopyNotice:       l.Form.EscalationCopyNotice,
		EscalationRecordOnlyNotice: l.Form.EscalationRecordOnlyNotice,
		EscalationInvalid:          l.Form.EscalationInvalid,
	}
}
