...
// PriceListModuleDeps holds all dependencies for the price list module.
type PriceListModuleDeps struct {
	Routes       epkg.Routes
	Labels       epkg.Labels
...
// PriceListModule holds all constructed price list views.
...
func NewPriceListModule(deps *PriceListModuleDeps) *PriceListModule {
...
func (m *PriceListModule) RegisterRoutes(r view.RouteRegistrar) {
