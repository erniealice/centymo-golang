...
import (
	...
	resourceaction "github.com/erniealice/centymo-golang/domain/product/resource/action"
	resourcelist "github.com/erniealice/centymo-golang/domain/product/resource/list"

	pyeza "github.com/erniealice/pyeza-golang"
	"github.com/erniealice/pyeza-golang/types"
	view "github.com/erniealice/pyeza-golang/view"

	epkg "github.com/erniealice/centymo-golang/domain/product/resource"
	resourcepb "github.com/erniealice/esqyma/pkg/schema/v1/domain/product/resource"
)

// ResourceModuleDeps holds all dependencies for the resource module.
type ResourceModuleDeps struct {
	Routes       epkg.Routes
	Labels       epkg.Labels
...
// ResourceModule holds all constructed resource views.
...
// NewResourceModule creates the resource module with all views wired.
func NewResourceModule(deps *ResourceModuleDeps) *ResourceModule {
...
func (m *ResourceModule) RegisterRoutes(r view.RouteRegistrar) {
