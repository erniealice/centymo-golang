...
func DefaultLabels() Labels {
	return Labels{
		...
		Form: FormLabels{
			...
			Role:               "Role",
			RolePlaceholder:    "e.g. eligible, primary, assistant, reviewer",
			RoleInfo:           "Pool membership role: eligible / primary / assistant (data-driven, not an enum). reviewer = reviews and approves every section of this offering; it does not make the staff member eligible to deliver.",
			Active:             "Active",
