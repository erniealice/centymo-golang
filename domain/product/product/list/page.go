...
func buildTableRows(products []*productpb.Product, status string, l product.Labels, cl pyeza.CommonLabels, routes product.Routes, inUseIDs map[string]bool, perms *types.UserPermissions, permEntity string, lineNameByID map[string]string) []types.TableRow {
	rows := []types.TableRow{}
...
func statusPageTitle(l product.Labels, status string) string {
	switch status {
	case "active":
...
func statusPageCaption(l product.Labels, status string) string {
	switch status {
	case "active":
...
func statusEmptyTitle(l product.Labels, status string) string {
	switch status {
	case "active":
...
func statusEmptyMessage(l product.Labels, status string) string {
	switch status {
	case "active":
