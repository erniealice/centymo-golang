...
import (
	...
	detail "github.com/erniealice/centymo-golang/domain/product/product/detail"
	"github.com/erniealice/centymo-golang/domain/product/product/detail/variant"
...
func BuildStockTabItems(productID, variantID, itemID string, l product.Labels, routes product.Routes) []pyeza.TabItem {
...
func BuildSerialTable(serials []*inventoryserialpb.InventorySerial, tableLabels types.TableLabels, productID, variantID, itemID string, l product.Labels, routes product.Routes) *types.TableConfig {
