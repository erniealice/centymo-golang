		...
		Nav: compose.NavContrib{
			...
			Items: []compose.NavItem{
				...
				{Key: "resources-active", Route: "resource.list", Params: map[string]string{"status": "active"},
					Label: "Active", Icon: "icon-check-circle", Permission: "resource:list", LabelKey: "active_label", IconKey: "resources_active_icon"},
				{Key: "resources-inactive", Route: "resource.list", Params: map[string]string{"status": "inactive"},
					Label: "Inactive", Icon: "icon-circle", Permission: "resource:list", LabelKey: "inactive_label", IconKey: "resources_inactive_icon"},
			},
		},
	}
}
