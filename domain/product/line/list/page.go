...
func productLineColumns(l product.LineLabels) []types.TableColumn {
...
func buildTableRows(lines []*linepb.Line, status string, l product.LineLabels, cl pyeza.CommonLabels, routes product.LineRoutes, inUseIDs map[string]bool, perms *types.UserPermissions) []types.TableRow {
	rows := []types.TableRow{}
...
func statusPageTitle(l product.LineLabels, status string) string {
	switch status {
	case "active":
...
func statusPageCaption(l product.LineLabels, status string) string {
	switch status {
	case "active":
...
func statusEmptyTitle(l product.LineLabels, status string) string {
	switch status {
	case "active":
...
func statusEmptyMessage(l product.LineLabels, status string) string {
	switch status {
	case "active":
