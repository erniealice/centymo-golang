...
func buildTabItems(l product.LineLabels, id string, routes product.LineRoutes) []pyeza.TabItem {
...
func buildAuditTable(l product.LineLabels, tableLabels types.TableLabels) *types.TableConfig {
