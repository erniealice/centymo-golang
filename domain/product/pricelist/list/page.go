...
func priceListColumns(l pricelist.Labels) []types.TableColumn {
...
func buildTableRows(priceLists []*pricelistpb.PriceList, status string, l pricelist.Labels, cl pyeza.CommonLabels, routes pricelist.Routes, inUseIDs map[string]bool, perms *types.UserPermissions) []types.TableRow {
	rows := []types.TableRow{}
...
func statusPageTitle(l pricelist.Labels, status string) string {
	switch status {
	case "active":
...
func statusPageCaption(l pricelist.Labels, status string) string {
	switch status {
	case "active":
...
func statusEmptyTitle(l pricelist.Labels, status string) string {
	switch status {
	case "active":
...
func statusEmptyMessage(l pricelist.Labels, status string) string {
	switch status {
	case "active":
