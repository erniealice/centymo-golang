...
func buildTabItems(id string, labels pricelist.Labels, routes pricelist.Routes) []pyeza.TabItem {
...
func buildPricesTable(ctx context.Context, deps *DetailViewDeps, priceListID string, routes pricelist.Routes, perms *types.UserPermissions) (*types.TableConfig, error) {
