...
func buildTabItems(id string, labels product.PriceListLabels, routes product.PriceListRoutes) []pyeza.TabItem {
	...
	return []pyeza.TabItem{
		...
		{Key: "audit-history", Label: labels.Detail.TabAuditHistory, Href: base + "?tab=audit-history", HxGet: action + "audit-history", Icon: "icon-clock"},
	}
}

func buildPricesTable(ctx context.Context, deps *DetailViewDeps, priceListID string, routes product.PriceListRoutes, perms *types.UserPermissions) (*types.TableConfig, error) {
