...
import (
	...
	productform "github.com/erniealice/centymo-golang/domain/product/views/product/form"
...
// product.ProductKindLabels) using reflection over the struct's JSON tags.
...
func productKindLabelMap(l product.ProductKindLabels) map[string]string {
...
func deliveryModeLabelMap(l product.DeliveryModeLabels) map[string]string {
	return map[string]string{
		"instant":      l.Instant,
...
func trackingModeLabelMap(l product.TrackingModeLabels) map[string]string {
	return map[string]string{
		"none":       l.None,
		"bulk":       l.Bulk,
...
func NewAddAction(deps *Deps) view.View {
	return view.ViewFunc(func(ctx context.Context, viewCtx *view.ViewContext) view.ViewResult {
		...
		return view.HTMXSuccess("products-table")
	})
}
