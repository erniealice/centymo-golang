...
func productColumns(l product.ProductLabels) []types.TableColumn {
...
func buildTableRows(products []*productpb.Product, status string, l product.ProductLabels, cl pyeza.CommonLabels, routes product.ProductRoutes, inUseIDs map[string]bool, perms *types.UserPermissions, permEntity string, lineNameByID map[string]string) []types.TableRow {
	rows := []types.TableRow{}
...
func statusPageTitle(l product.ProductLabels, status string) string {
	switch status {
	case "active":
...
func statusPageCaption(l product.ProductLabels, status string) string {
	switch status {
	case "active":
...
func statusEmptyTitle(l product.ProductLabels, status string) string {
	switch status {
	case "active":
...
func statusEmptyMessage(l product.ProductLabels, status string) string {
	switch status {
	case "active":
