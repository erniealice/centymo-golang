...
func NewView(deps *ListViewDeps) view.View {
	return view.ViewFunc(func(ctx context.Context, viewCtx *view.ViewContext) view.ViewResult {
		...
		if !perms.Can("product_line", "list") {
			return view.Forbidden("product_line:list")
		}
		_ = perms
...
func productLineColumns(l product.ProductLineLabels) []types.TableColumn {
...
func buildTableRows(lines []*linepb.Line, status string, l product.ProductLineLabels, routes product.ProductLineRoutes, inUseIDs map[string]bool, perms *types.UserPermissions) []types.TableRow {
	rows := []types.TableRow{}
...
func statusPageTitle(l product.ProductLineLabels, status string) string {
	switch status {
	case "active":
...
func statusPageCaption(l product.ProductLineLabels, status string) string {
	switch status {
	case "active":
...
func statusEmptyTitle(l product.ProductLineLabels, status string) string {
	switch status {
	case "active":
...
func statusEmptyMessage(l product.ProductLineLabels, status string) string {
	switch status {
	case "active":
