...
func buildTabItems(l product.ProductLineLabels, id string, routes product.ProductLineRoutes) []pyeza.TabItem {
...
func buildAuditTable(l product.ProductLineLabels, tableLabels types.TableLabels) *types.TableConfig {
