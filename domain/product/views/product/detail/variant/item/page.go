...
import (
	...
	detail "github.com/erniealice/centymo-golang/domain/product/views/product/detail"
	"github.com/erniealice/centymo-golang/domain/product/views/product/detail/variant"
...
func BuildStockTabItems(productID, variantID, itemID string, l product.ProductLabels, routes product.ProductRoutes) []pyeza.TabItem {
...
func BuildSerialTable(serials []*inventoryserialpb.InventorySerial, tableLabels types.TableLabels, productID, variantID, itemID string, l product.ProductLabels, routes product.ProductRoutes) *types.TableConfig {
