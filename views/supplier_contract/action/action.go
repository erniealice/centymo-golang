...
import (
	...
	"github.com/erniealice/centymo-golang/views/supplier_contract/form"
)
...
func buildEmptyFormData(ctx context.Context, deps *Deps, l centymo.SupplierContractLabels) *form.Data {
	fd := &form.Data{
		Labels:       l.Form,
