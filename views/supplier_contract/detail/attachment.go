...
// NewAttachmentUploadAction creates the upload handler for supplier_contract attachments.
func NewAttachmentUploadAction(deps *DetailViewDeps) view.View {
	return attachment.NewUploadAction(attachmentConfig(deps))
}

// NewAttachmentDeleteAction creates the delete handler for supplier_contract attachments.
