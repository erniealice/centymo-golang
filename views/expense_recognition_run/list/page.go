...
func expenseRunColumns(l centymo.ExpenseRecognitionRunLabels) []types.TableColumn {
	lc := l.List.Columns
...
func buildTableRows(rows []errshared.ExpenseRecognitionRunRow, l centymo.ExpenseRecognitionRunLabels, routes centymo.ExpenseRecognitionRunRoutes) []types.TableRow {
...
func statusBadge(l centymo.ExpenseRecognitionRunLabels, status string) (label, variant string) {
	switch status {
	case "pending":
...
func scopeKindLabel(l centymo.ExpenseRecognitionRunLabels, kind string) string {
	switch kind {
	case "supplier":
...
func statusPageTitle(l centymo.ExpenseRecognitionRunLabels, status string) string {
	switch status {
	case "pending":
...
func statusEmptyTitle(l centymo.ExpenseRecognitionRunLabels, status string) string {
	switch status {
	case "pending":
...
func statusEmptyMessage(l centymo.ExpenseRecognitionRunLabels, status string) string {
	switch status {
	case "pending":
