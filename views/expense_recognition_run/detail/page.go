...
import (
	...
	detailform "github.com/erniealice/centymo-golang/views/expense_recognition_run/detail/form"
...
func buildTabItems(l centymo.ExpenseRecognitionRunLabels, id string, routes centymo.ExpenseRecognitionRunRoutes) []pyeza.TabItem {
...
func buildSelectionsTable(attempts []errshared.ExpenseRecognitionRunAttemptRow, l centymo.ExpenseRecognitionRunLabels, tableLabels types.TableLabels) *types.TableConfig {
...
func buildResultsTable(attempts []errshared.ExpenseRecognitionRunAttemptRow, l centymo.ExpenseRecognitionRunLabels, tableLabels types.TableLabels) *types.TableConfig {
	lr := l.Detail.Results
	columns := []types.TableColumn{
...
func buildBillsTable(rows []errshared.ExpenditureRow, l centymo.ExpenseRecognitionRunLabels, tableLabels types.TableLabels) *types.TableConfig {
	lb := l.Detail.Bills
	columns := []types.TableColumn{
...
func buildRecognitionsTable(rows []errshared.ExpenseRecognitionRow, l centymo.ExpenseRecognitionRunLabels, tableLabels types.TableLabels) *types.TableConfig {
...
func outcomeCell(l centymo.ExpenseRecognitionRunLabels, outcome string) (label, variant string) {
	switch outcome {
	case "created":
...
func sourceKindLabel(l centymo.ExpenseRecognitionRunLabels, kind string) string {
	switch kind {
