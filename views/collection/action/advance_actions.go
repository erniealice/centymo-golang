...
type AdvanceActionDeps struct {
	...
	RefundUnscheduled func(ctx context.Context, in centymo.AdvanceRefundViewInput) (*centymo.AdvanceRefundViewOutput, error)
	Cancel            func(ctx context.Context, in centymo.AdvanceCancelViewInput) (*centymo.AdvanceCancelViewOutput, error)
}
