...
type Deps struct {
	Routes                     centymo.JobActivityRoutes
	...
	Labels                     centymo.JobActivityLabels
...
func activityColumns(l centymo.JobActivityLabels) []types.TableColumn {
...
func buildTableRows(activities []*jobactivitypb.JobActivity, l centymo.JobActivityLabels, routes centymo.JobActivityRoutes, perms *types.UserPermissions) []types.TableRow {
	rows := []types.TableRow{}
	for _, a := range activities {
		...
		amount := centymo.FormatCentavoAmount(a.GetTotalCost(), currency)
