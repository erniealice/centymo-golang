...
func activityToMap(a *jobactivitypb.JobActivity) map[string]any {
	...
	unitCost := centymo.FormatCentavoAmount(a.GetUnitCost(), currency)
	totalCost := centymo.FormatCentavoAmount(a.GetTotalCost(), currency)
...
func NewView(deps *Deps) view.View {
	return view.ViewFunc(func(ctx context.Context, viewCtx *view.ViewContext) view.ViewResult {
		...
		amount := centymo.FormatCentavoAmount(record.GetTotalCost(), currency)
