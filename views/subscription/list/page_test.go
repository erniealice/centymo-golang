...
func testSubLabels() centymo.SubscriptionLabels {
	l := centymo.DefaultSubscriptionLabels()
...
func testSubRoutes() centymo.SubscriptionRoutes {
	return centymo.DefaultSubscriptionRoutes()
}
