...
// NewAttachmentUploadAction creates the upload handler for price_schedule attachments.
func NewAttachmentUploadAction(deps *DetailViewDeps) view.View {
	return attachment.NewUploadAction(attachmentConfig(deps))
}

// NewAttachmentDeleteAction creates the delete handler for price_schedule attachments.
