...
func disbursementToMap(d *disbursementpb.Disbursement, enumLabels centymo.AdvanceEnumLabels) map[string]any {
...
func buildTabItemsWithAdvance(l centymo.DisbursementLabels, id string, routes centymo.DisbursementRoutes, isAdvance bool, advanceTabLabel string) []pyeza.TabItem {
