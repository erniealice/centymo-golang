...
// NewAttachmentUploadAction creates the upload handler for disbursement attachments.
func NewAttachmentUploadAction(deps *Deps) view.View {
	return attachment.NewUploadAction(attachmentConfig(deps))
}

// NewAttachmentDeleteAction creates the delete handler for disbursement attachments.
