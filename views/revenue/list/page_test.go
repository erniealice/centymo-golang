...
func testRevenueLabels() centymo.RevenueLabels {
	return centymo.RevenueLabels{
		...
		Actions: centymo.RevenueActionLabels{
			View:               "View",
			Edit:               "Edit",
			Complete:           "Complete",
			Cancel:             "Cancel",
...
func testRevenueRoutes() centymo.RevenueRoutes {
	return centymo.DefaultRevenueRoutes()
}
