...
// NewAttachmentUploadAction creates the upload handler for procurement_request attachments.
func NewAttachmentUploadAction(deps *DetailViewDeps) view.View {
	return attachment.NewUploadAction(attachmentConfig(deps))
}

// NewAttachmentDeleteAction creates the delete handler for procurement_request attachments.
