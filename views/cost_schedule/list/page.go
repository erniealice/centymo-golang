...
func costScheduleColumns(l centymo.CostScheduleLabels) []types.TableColumn {
...
func buildTableRows(ctx context.Context, schedules []*costschedulepb.CostSchedule, status string, l centymo.CostScheduleLabels, routes centymo.CostScheduleRoutes, perms *types.UserPermissions) []types.TableRow {
...
func statusTitle(l centymo.CostScheduleLabels, status string) string {
	switch status {
	case "active":
