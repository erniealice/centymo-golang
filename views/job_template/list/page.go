...
type Deps struct {
	Routes                     centymo.JobTemplateRoutes
	...
	Labels                     centymo.JobTemplateLabels
...
func jobTemplateColumns(l centymo.JobTemplateLabels) []types.TableColumn {
...
func buildTableRows(templates []*jobtemplatepb.JobTemplate, status string, l centymo.JobTemplateLabels, routes centymo.JobTemplateRoutes, perms *types.UserPermissions) []types.TableRow {
	rows := []types.TableRow{}
...
func statusTitle(l centymo.JobTemplateLabels, status string) string {
	switch status {
	case "active":
...
func statusSubtitle(l centymo.JobTemplateLabels, status string) string {
	switch status {
	case "active":
...
func statusEmptyTitle(l centymo.JobTemplateLabels, status string) string {
	switch status {
	case "active":
...
func statusEmptyMessage(l centymo.JobTemplateLabels, status string) string {
	switch status {
	case "active":
